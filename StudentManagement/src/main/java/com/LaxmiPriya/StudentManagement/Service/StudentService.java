...
public class StudentService {
	...
	public UpdateResponseDto addStudent(CreateRequestDto createDto) throws EmailAlreadyExistsException, CourseNotFoundException {
		...
		Course course=courseRepo.findByCourseName(createDto.getCourseName()).orElseThrow(()->new CourseNotFoundException("Course not found"));
	...
	public UpdateResponseDto updateStudent(Long id, @RequestBody CreateRequestDto createRequest)
		...
		Course course=courseRepo.findByCourseName(createRequest.getCourseName()).orElseThrow(()->new CourseNotFoundException("Course not found"));
	...
	/*public List<Student> IgnoreCase(String prefix) {
		return studentRepo.findByFirstnameIgnoreCase(prefix);
	}*/
}
